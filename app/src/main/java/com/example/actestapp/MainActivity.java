...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_MESSAGE = "com.example.actestapp.extra.MESSAGE";
     ...
     * @param_view The view (Button) that was clicked.
     */

    public void launchSecondActivity(View view) {
        Intent explicitIntent = new Intent(this, SecondActivity.class);
        explicitIntent.putExtra(EXTRA_MESSAGE, mMessageEditText.getText().toString());
        Log.d(LOG_TAG, "Intent.outExtra");
        startActivityForResult(explicitIntent, TEXT_REQUEST);
